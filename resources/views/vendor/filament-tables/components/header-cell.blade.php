...
>
    ...
    >
        <span
            class="fi-ta-header-cell-label text-sm font-semibold text-gray-950"
        >
            {{ $slot }}
        </span>
        ...
        @if ($sortable)
            <x-filament::icon
                ...
                @class([
                    ...
                    'text-gray-950' => $activelySorted,
                    'text-gray-400 group-hover:text-gray-500 group-focus-visible:text-gray-500' => ! $activelySorted,
                ])
            />
        @endif
    </{{ $sortable ? 'button' : 'span' }}>
