...
>
        ...
        @else
            <script>
                ...
                document.addEventListener('alpine:init', () => {
                    ...
                    window.Alpine.store('companybar', {
                        isOpen: false,
                        ...
                        toggle: function () {
                            ...
                            if (this.isOpen) {
                                Alpine.store('panelsbar').isOpen = false;
                                Alpine.store('userbar').isOpen = false;
                                Alpine.store('providerbar').isOpen = false;
                                Alpine.store('calendarbar').isOpen = false;
                                Alpine.store('todosbar').isOpen = false;
                            }
                        },
                    })

                    window.Alpine.store('panelsbar', {
                        isOpen: false,
                        ...
                        toggle: function () {
                            ...
                            if (this.isOpen) {
                                ...
                                Alpine.store('companybar').isOpen = false;
                                Alpine.store('userbar').isOpen = false;
                                Alpine.store('providerbar').isOpen = false;
                                Alpine.store('calendarbar').isOpen = false;
                                Alpine.store('todosbar').isOpen = false;
                    ...
                    window.Alpine.store('providerbar', {
                        isOpen: false,
                    ...
                    window.Alpine.store('calendarbar', {
                        isOpen: false,
    ...
    >
        ...
        <x-filament-panels::mini-side-bar />
        {{ $slot }}
