...
>
    <div class="overflow-x-clip">
        <header
            class="fi-sidebar-header flex h-12 bg-white shadow-sm border-r items-center px-6"
        >
            <div
    ...
    <nav
        class="fi-sidebar-nav flex-grow bg-white flex flex-col gap-y-7 overflow-y-auto overflow-x-hidden px-6 py-4 border-r"
