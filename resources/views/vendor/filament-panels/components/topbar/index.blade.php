...
>
    <nav
        class="flex h-12 items-center gap-x-4 bg-white px-4 shadow-sm ring-1 ring-gray-950/5 md:px-4 lg:px-6"
    >
    ...
    @if(filament()->hasTopNavigation() || (! filament()->hasNavigation()))
    <nav
        class="hidden lg:flex h-12 items-center gap-x-4 bg-white shadow-sm ring-1 ring-gray-950/5 px-2 md:px-2 lg:px-2"
    >
        @if (filament()->hasNavigation())
