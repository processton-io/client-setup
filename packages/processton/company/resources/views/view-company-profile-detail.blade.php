...
<div class="w-full">
    ...
    <div class="relative">
      <!-- User Avatar -->
      <img class="w-40 h-40 rounded-md object-cover" src="{{ $record->profile_url }}"
        alt="{{$record->name}}" />
    </div>
    ...
    <div class="flex flex-col px-6">
      ...
      <div class="my-2 flex flex-row space-x-2">
        ...
        <div class="flex flex-row">
          ...
          <div class="text-xs text-gray-400/80 hover:text-gray-400">{{$record->industry}}</div>
        </div>
        ...
        <div class="flex flex-row">
          ...
          <div class="text-xs text-gray-400/80 hover:text-gray-400">{{$record->name}}</div>
        </div>
        ...
        <div class="flex flex-row">
          ...
          <div class="text-xs text-gray-400/80 hover:text-gray-400">{{$record->domain}}</div>
        </div>
      </div>
